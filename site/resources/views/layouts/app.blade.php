...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="nav-container ">
        ...
        <div class="main-container">
            <section class="text-center height-50 imagebg" data-overlay="4">
                <!-- <div class="background-image-holder">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="typed-headline">
                                <span class="h1 inline-block">GDweb &mdash;</span>
                                <span class="h1 inline-block typed-text typed-text--cursor color--primary" data-typed-strings="E-commerce,Site Vitrine,Reférencement"></span>
                            </div>
                            <p class="lead">
                            ...
                            <span class="block type--fine-print">
                                <a href="{{ url('/projets') }}">voir les dernieres projets</a>
                            </span>
                        </div>
                    </div>
                    <!--end of row-->
